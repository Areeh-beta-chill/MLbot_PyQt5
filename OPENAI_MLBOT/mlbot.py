...
class MainWindow(QWidget):
    def __init__(self): 
        super().__init__()
        self.init_ui()  # def init initializes the UI
    ...
    def init_ui(self):
        ...
        self.popular_questions_button = QPushButton('Popular Questions')
        self.popular_questions_layout = QVBoxLayout()
        self.popular_questions = ["What is the best way of learning ML?", "What are the difference between ML and DL "]
        ...
        self.setWindowTitle('ML carrer Advisor')
        self.setGeometry(200, 200, 600, 800)

        # connect the submit button which quiries OpenAI's API:
    ...
    def get_answer(self):
        ...
        completion = openai.ChatCompletion.create(
            model = "gpt-3.5-turbo",
            messages = [{"role":"user", "content":"You are a ML engineering expert. Answer the following questions in a concise way."},
